...
#define TIMEOUT2        30000     //30초 타임아웃
...
private:
	////////////////////////////////////////////////////////////////////////////
    // ChatServer 자료 구조 및 멤버 - 인증 컨텐츠 추가
    ////////////////////////////////////////////////////////////////////////////
	LFQueue<JOB*>*                      m_pAuthJobQ;
...
private:
	void         Mem_Init(INT userMAX, INT updateFrame, const CHAR* redisip, INT redisport, WCHAR* MonitorIp, INT MonitorPort);
	void         Thread_Create();
	void         Thread_Destroy();
	...
	void AuthComProc(UINT64 sessionID, CMessage* pMessage);

	///////////////////////////////////////////////////////////////////////////
    // Auth Job 핸들러
    ///////////////////////////////////////////////////////////////////////////
	void AuthReqProc(UINT64 sessionID, CMessage* pMessage);

	///////////////////////////////////////////////////////////////////////////
    // 인증 처리 관련 함수
    ///////////////////////////////////////////////////////////////////////////
	void AuthCompleteJob(UINT64 sessionID, CMessage* pMessage);
	void AuthRequestJob(UINT64 sessionID, CMessage* pMessage);
